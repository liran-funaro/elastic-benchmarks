...
try:
    import libvirt
    libvirt_error = libvirt.libvirtError
except ImportError:
    libvirt = None
    libvirt_error = None
...
class LibvirtInterface:
    ...
    def _connect(self):
        try:
            ...
            self.logger.error("Error setting up connection: %s", e.message)
    ...
    def _reconnect(self):
        ...
        try:
            ...
            self.logger.error("Exception while reconnecting: %s", e.message)
    ...
    def lookupByName(self, dom_name):
        try:
    ...
    def domainGetXmlDesc(self, domain):
        try:
    ...
    def domainMaxMemory(self, domain):
        try:
            mem = domain.maxMemory()
        except libvirt.libvirtError as e:
            self.handleException(e)
            return 0
        return mem
