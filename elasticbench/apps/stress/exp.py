...
from elasticbench.apps.stress import Stress, StressBenchmark

from elasticbench.exp import default_single_vm_args, default_static_test


STRESS_EXP_NAME = 'stress'
...
def static_test(load: Union[int, FunctionOfTime] = 1, memory_alloc=4096, duration=(1, 'h'), **kwargs):
    return default_static_test(STRESS_EXP_NAME, default_args, load, memory_alloc, duration, **kwargs)
